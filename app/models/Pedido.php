...
class Pedido
{
    ...
    public function crearPedido()
    {
        ...
        $consulta = $objAccesoDatos->prepararConsulta("INSERT INTO pedidos (idUsuario, idProducto, idMesa, unidades, nombreCliente, horaInicio, fecha, estado) VALUES (:usuario, :producto, :mesa, :unidades, :nombre, :horaInicio, :fecha, :estado)");
